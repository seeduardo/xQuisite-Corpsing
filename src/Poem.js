  ...
  render() {
    ...
    return(
      poem.later_lines.length === 9
        ? <div className="poem">
            <p>The first line of this creation was evoked from the mystery of the ether, but the remaining lines were forged by the following xQuisite Corpseers respectively: {poem.later_lines.map(
